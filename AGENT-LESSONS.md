...
### 1.2 WebUI Component Alignment (W28A-715, W28A-965)
...
### 1.3 All 8 Connectors ARE Implemented
...
### 1.6 API-REFERENCE.md Uplift (W28A-997)
...
### 1.7 Traceability Matrix Gap Triage (W28A-1001)
...
### 2.2 MongoDB Test URI Mismatch (W28A-965 fix)
...
### 2.3 PostgreSQL/MariaDB Connector Credentials
...
### 2.4 Test Counts (W28A-966a baseline, 2026-04-21)
...
### 3.2 Backend Infrastructure (all Terraform-managed, DO NOT provision)
| Backend | Host | Port |
|---------|------|------|
