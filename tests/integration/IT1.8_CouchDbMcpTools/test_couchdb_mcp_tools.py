...
#
# Description: Integration test for CouchDB MCP tools against a real local CouchDB 3 runtime.
...
def test_couchdb_mcp_tools_crud_lifecycle() -> None:
    """CouchDB MCP tools should perform real CRUD against a real local CouchDB runtime."""
    ...
    try:
        ...
        assert {"widgets", "common/by_status"}.issubset(entity_names)
        ...
        assert created.json()["data"]["document"]["doc_type"] == "widgets"
