...
# db-mcp-server — W28C-1711 Knowledge Preservation Delta

## Per-test SHA chain (additive marker swap only)

- Test files in `tests/`: 58
- Files with probe markers swapped to req(): 3
- Probes mechanically bound to req('FR/CS-NNN'): 18
- Probes retained for operator review (no confident FR match): 128
