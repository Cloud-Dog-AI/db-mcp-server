...
# db-mcp-server — REQUIREMENTS Design Delta (W28C-1710b)
...
`db-mcp-server` declares surfaces: **api, mcp, a2a, webui**.
...
- `docs/REQUIREMENTS.md` pre-sha256: `5ec753fb8599`
- `docs/ROLES-AND-USECASES.md` pre-sha256: `7c02880f65e9`
- `docs/TESTS.md` pre-sha256: `c2e08e8681c0`
