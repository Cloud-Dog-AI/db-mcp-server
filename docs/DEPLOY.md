...
## Deployment Notes
- Service focus: Multi-backend database and search control plane for discovery, CRUD, relationships, search indexing, schema planning, and PS-30 Web UI administration.
- Primary capabilities: profile and access control, catalog and content CRUD, relationship management, search indexing, schema change planning and apply.
