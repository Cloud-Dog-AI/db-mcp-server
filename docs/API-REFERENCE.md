...
<!-- W28C-1710a recovery: full content from archive/2026-06-12/API_DOCUMENTATION.md (archived sha256=ab26f475278b, 62 lines) -->

## Recovered domain content — `archive/2026-06-12/API_DOCUMENTATION.md` (62 lines)

_This section carries forward the full content of the archived predecessor doc verbatim. Topic checklist + SHA256 chain in `cloud-dog-ai-platform-standards/working/evidence/W28C-1710a/per-doc/db-mcp-server/API_DOCUMENTATION.md.topics.tsv`. Archive contents are unchanged (sha256 stable)._
