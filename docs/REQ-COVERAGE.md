...
|---|---|---|---|---|---|---|---|
| CS-001 | api, mcp, a2a, webui | — | tests/unit/UT1.52_FlatLoginContract/test_flat_login_contract.py, tests/unit/UT1.52_FlatLoginContract/test_flat_login_contract.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-002 | api, mcp | — | tests/unit/UT1.22_TestDataSeed/test_test_data_seed_api.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-003 | api | — | tests/unit/UT1.22_TestDataSeed/test_test_data_seed_api.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-004 | mcp | — | tests/unit/UT1.22_TestDataSeed/test_test_data_seed_api.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-005 | api | — | tests/unit/UT1.52_FlatLoginContract/test_flat_login_contract.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-006 | mcp | — | tests/unit/UT1.52_FlatLoginContract/test_flat_login_contract.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-007 | a2a | — | tests/unit/UT1.52_FlatLoginContract/test_flat_login_contract.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-008 | webui | — | tests/unit/UT1.52_FlatLoginContract/test_flat_login_contract.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-009 | api | — | tests/unit/UT1.22_TestDataSeed/test_test_data_seed_api.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-010 | mcp | — | tests/unit/UT1.22_TestDataSeed/test_test_data_seed_api.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-011 | a2a | — | tests/unit/UT1.22_TestDataSeed/test_test_data_seed_api.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-012 | webui | — | tests/unit/UT1.52_FlatLoginContract/test_flat_login_contract.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-013 | api | — | tests/unit/UT1.22_TestDataSeed/test_test_data_seed_api.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-014 | mcp | — | tests/unit/UT1.22_TestDataSeed/test_test_data_seed_api.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-015 | a2a | — | tests/unit/UT1.22_TestDataSeed/test_test_data_seed_api.py | pass | 973991f8 | 1 | COVERED-PASSING |
| CS-016 | webui | — | tests/unit/UT1.52_FlatLoginContract/test_flat_login_contract.py | pass | 973991f8 | 1 | COVERED-PASSING |
...
| FR-002 | api, a2a | must | tests/unit/UT1.2_AuthMiddleware/test_auth_middleware.py, tests/unit/UT1.2_AuthMiddleware/test_auth_middleware.py, tests/unit/UT1.2_AuthMiddleware/test_auth_middleware.py, tests/unit/UT1.2_AuthMiddleware/test_auth_middleware.py, tests/unit/UT1.2_AuthMiddleware/test_auth_middleware.py, tests/unit/UT1.2_AuthMiddleware/test_auth_middleware.py | pass | 973991f8 | 1 | COVERED-PASSING |
| FR-003 | api, mcp, webui | must | tests/unit/UT1.3_AccessControlService/test_access_control_service.py, tests/unit/UT1.3_AccessControlService/test_access_control_service.py, tests/unit/UT1.3_AccessControlService/test_access_control_service.py, tests/unit/UT1.3_AccessControlService/test_access_control_service.py, tests/unit/UT1.3_AccessControlService/test_access_control_service.py, tests/unit/UT1.3_AccessControlService/test_access_control_service.py, tests/unit/UT1.3_AccessControlService/test_access_control_service.py, tests/system/ST1.2_AccessControlApi/test_access_control_api.py, tests/integration/IT1.14_IdamCascadeNegative/test_dbmcp_idam_negative.py, tests/integration/IT1.1_AccessControlLifecycle/test_access_control_lifecycle.py | pass | 973991f8 | 1 | COVERED-PASSING |
| FR-004 | api, mcp, webui | must | tests/unit/UT1.21_ProfileScopeAndSchemaApproval/test_profile_scope_schema_approval.py, tests/unit/UT1.21_ProfileScopeAndSchemaApproval/test_profile_scope_schema_approval.py, tests/unit/UT1.21_ProfileScopeAndSchemaApproval/test_profile_scope_schema_approval.py, tests/integration/IT1.11_SourceConnections/test_source_connections_api.py | pass | 973991f8 | 1 | COVERED-PASSING |
| FR-005 | api, mcp | must | tests/unit/UT1.6_CatalogTools/test_catalog_tools.py, tests/unit/UT1.20_DiscoveryApi/test_discovery_api.py, tests/system/ST1.4_CatalogApi/test_catalog_api.py, tests/integration/IT1.15_McpJsonRpcEnvelope/test_mcp_jsonrpc_tools_call.py, tests/integration/IT1.3_FullDiscoveryFlow/test_full_discovery_flow.py | pass | 973991f8 | 1 | COVERED-PASSING |
| FR-006 | api, mcp | must | tests/unit/UT1.7_ContentTools/test_content_tools.py, tests/system/ST1.5_ContentApi/test_content_api.py, tests/system/ST1.5_ContentApi/test_content_api.py, tests/system/ST1.5_ContentApi/test_content_api.py, tests/integration/IT1.4_ContentCRUDLifecycle/test_content_crud_lifecycle.py | pass | 973991f8 | 1 | COVERED-PASSING |
| FR-007 | api, mcp | must | tests/unit/UT1.5_FilterModel/test_filter_model.py, tests/unit/UT1.5_FilterModel/test_filter_model.py, tests/unit/UT1.5_FilterModel/test_filter_model.py | pass | 973991f8 | 1 | COVERED-PASSING |
